 ...
 * @version 2023.03.24 22:35:12 // Generated by ComTest
 *
 */
...
public class LapRecordTrackerTest {
  ...
  // Generated by ComTest BEGIN
  /** testAnnaKilparadat62 */
  @Test
  public void testAnnaKilparadat62() {    // LapRecordTracker: 62
    ...
    assertEquals("From: LapRecordTracker line: 78", 0, loytyneet.size()); 
    loytyneet = laprecordtracker.annaKilparadat(zonda1); 
    assertEquals("From: LapRecordTracker line: 80", 2, loytyneet.size()); 
    assertEquals("From: LapRecordTracker line: 81", true, loytyneet.get(0) == kilpa11); 
    assertEquals("From: LapRecordTracker line: 82", true, loytyneet.get(1) == kilpa12); 
    loytyneet = laprecordtracker.annaKilparadat(zonda2); 
    assertEquals("From: LapRecordTracker line: 84", 3, loytyneet.size()); 
    assertEquals("From: LapRecordTracker line: 85", true, loytyneet.get(0) == kilpa21); 
  } // Generated by ComTest END
}